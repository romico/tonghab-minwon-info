...
캡처 스크립트·`docsSnapshot` 마스킹 구현은 브랜치 `feat/site-snapshot-capture` 에서 관리한다.

```bash
git switch feat/site-snapshot-capture
...
### 01 대시보드
![대시보드](./01-dashboard.png)

### 02 관리대장
![관리대장](./02-ledger.png)

### 02b 민원 등록
![민원 등록](./02b-ledger-register.png)

### 03 부서별현황
![부서별현황](./03-departments.png)
